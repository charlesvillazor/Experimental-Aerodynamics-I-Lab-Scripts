Column definitions in the provided data files: P_transducer (psf) | h_manometer (inches) | I_sensor (mA) - 5 columns | T_transducer (degree F)

Notes:
- Manometer off-set = 0.85 inches.
...
- Average out the sensor current reading to get a single current for a given pressure setting.
